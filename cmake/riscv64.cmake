...
set(CMAKE_CXX_COMPILER ${CROSS_CHAIN_PATH}/gcc/riscv64-linux-musl-x86_64/bin/riscv64-unknown-linux-musl-g++)

# 设置编译标志
set(CMAKE_C_FLAGS "-mcpu=c906fdv -march=rv64imafdcv0p7xthead -mcmodel=medany -mabi=lp64d -latomic")
set(CMAKE_CXX_FLAGS "-mcpu=c906fdv -march=rv64imafdcv0p7xthead -mcmodel=medany -mabi=lp64d -latomic")

add_definitions(-D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64)

# where is the target environment
SET(CMAKE_FIND_ROOT_PATH  ${CROSS_CHAIN_PATH}/gcc/riscv64-linux-musl-x86_64/sysroot)
